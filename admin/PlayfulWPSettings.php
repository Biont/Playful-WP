...
class PlayfulWPSettings {
    ...
    private function __construct() {
        ...
        // Add the options page and menu item.
        add_action( 'admin_menu', array( $this, 'add_plugin_admin_menu' ), 0 );
    }
...
//        exit;
    ...
    public function add_plugin_admin_menu() {
        ...
        $this->plugin_screen_hook_suffix = add_menu_page(
                __( 'Playful WP Settings', $this->plugin_slug ), __( 'PlayfulWP', $this->plugin_slug ), 'manage_options', 'playful_wp_settings', array( $this, 'display_admin_page' ), '', 19
        );
